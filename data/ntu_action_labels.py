"""NTU RGB+D 120 action class labels (A1-A120).

Source: shahroudy/NTURGB-D README.md "Action Classes" section, fetched
2026-07-14 (https://github.com/shahroudy/NTURGB-D). A50-A120 are two-person
("mutual") actions; A1-A49 are single-performer.

This was transcribed via an automated fetch of the raw README, not a
byte-for-byte diff against the file — spot-check a few entries (e.g. A1,
A60, A120) against your own copy of the dataset's label list before trusting
this for anything beyond the Day-1/Day-2 smoke tests.
"""
